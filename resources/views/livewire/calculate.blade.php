<div class="flex flex-col items-center bg-gray-100 dark:bg-gray-900 rounded-xl py-8 border dark:border-gray-700">
    ...
    <form wire:submit.prevent="calcular" class="w-full mt-6 max-w-lg bg-white dark:bg-gray-800 p-6 rounded-xl shadow-md">
        ...
        <div class="form-group mb-4">
            ...
            <input wire:model.defer="peso" type="number" id="peso" class="w-full mt-1 px-3 py-2 border border-gray-300 dark:border-gray-700 shadow-sm placeholder-gray-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block rounded-xl sm:text-sm focus:ring-1 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100" placeholder="Ingrese el peso">
            @error('peso')
        ...
        <div class="form-group mb-4">
            ...
            <input wire:model.defer="peso_levantado" type="number" id="peso_levantado" class="w-full mt-1 px-3 py-2 border border-gray-300 dark:border-gray-700 shadow-sm placeholder-gray-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block rounded-xl sm:text-sm focus:ring-1 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100" placeholder="Ingrese el peso levantado">
        ...
        <div class="form-group mb-4">
            ...
            <input wire:model.defer="repeticiones" type="number" id="repeticiones" class="w-full mt-1 px-3 py-2 border border-gray-300 dark:border-gray-700 shadow-sm placeholder-gray-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block rounded-xl sm:text-sm focus:ring-1 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100" placeholder="Ingrese el número de repeticiones">
            @error('repeticiones')
                <div class="text-red-500 text-sm mt-1">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="flex justify-center">
            <button type="submit" class="w-80 flex px-4 py-2 rounded-lg font-bold" style="background-color: #94B431; color: white; border: none; hover:bg-blue-600; focus:outline-none; focus:ring-2; focus:ring-blue-500;">
