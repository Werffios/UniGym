<div class="flex flex-col items-center bg-gray-100 dark:bg-gray-900 rounded-xl py-8 border dark:border-gray-700">
    ...
    <form wire:submit.prevent="filter" class="w-full mt-2 max-w-lg bg-white dark:bg-gray-800 p-6 rounded-xl shadow-md">
        ...
        <div class="flex justify-center">
          <button type="submit" class="w-80 mt-6 flex px-4 py-2 rounded-md font-bold" style="background-color: #94B431; color: white; border: none; hover:bg-blue-600; focus:outline-none; focus:ring-2; focus:ring-blue-500;">            
    ...
    @if($totalAttendances)
        ...
        <div class="w-1/2 mt-6 p-10 bg-white dark:bg-gray-800 dark:border-gray-700 rounded-xl shadow-md text-center justify-between">
          ...
          <div class="flex justify-center mb-4">            
            <button wire:click="export" class="flex mt-3 px-4 py-2 rounded-md font-bold" style="background-color: #3B82F6; color: white; border: none; hover:bg-blue-700; focus:outline-none; focus:ring-2; focus:ring-blue-500;">
              Exportar a Excel
